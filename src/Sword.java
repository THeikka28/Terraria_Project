...
public class Sword {
    ...
    public void attack() {
            ...
            slice = Toolkit.getDefaultToolkit().getImage("Slash.jpeg"); //load the picture
            }
            if(isattacking == true && angle <-45 && angle >-135)
            {
            hitbox = new Rectangle((int) xpos-60, (int) ypos-130, (int) width+60, (int) height+20);
            slice = Toolkit.getDefaultToolkit().getImage("Slash copy3.jpeg"); //load the picture
            }
            if(isattacking == true && angle <-135)
            {
            hitbox = new Rectangle((int) xpos-110, (int) ypos-60, (int) width+20, (int) height+60);
            slice = Toolkit.getDefaultToolkit().getImage("Slash copy2.jpeg"); //load the picture
            }
            if(isattacking == true && angle >135)
            {
                hitbox = new Rectangle((int) xpos-110, (int) ypos-60, (int) width+20, (int) height+60);
            ...
            {
                slice = Toolkit.getDefaultToolkit().getImage("Slash copy.jpeg"); //load the picture
